...
**Overall markup — Jul '26:** 9.62x vs 7.34x last year (+2.28x).
...
| Jul | $4,643,426 | $4,002,261 | -$641,165 | -13.8% | ~$27.50M | $28,562,340 |
| **YTD** | **$28,562,340** | **~$27.50M** | **~-$1.07M** | **~-3.7%** | | |
...
|--:|---|---|---|
| 1 | UBS | $200K tech (3 yr) + ~$200K/yr services | GL Enterprise contract signed — net-new; land-and-expand, services scale from here |
| 2 | LendingUSA | $10,000 | TPC contract signed |

## Highest-Value Pipeline (Pending Close)

| # | Account | Value | Status | Risk Flag |
|--:|---|---|---|---|
| 1 | Bread Financial | $258,470.88 | BPO — disco across 3 separate LOBs (Vion running) | Multi-LOB, early stage; large upside if it lands |
| 2 | Program Consulting | $175K | 12-month contract | Consulting team; terms in progress |
| 3 | RBC AI | $100K | Proposal discussion | Large bank; slow procurement |
| 4 | RBC – Staffing FRCA Language Lead | Min $86K/yr | Proposal out (Consulting team) | Approval cycle |
| 5 | Landmark CU | Unquantified | TPC disco; BPO also pitched | Early disco |
| 6 | Sauce | Unquantified | Disco — VP Customer Support (Josh Boock), post-CCW | Early disco |

## Newsletter performance

- Sent **** · 6,005 sent / 0 delivered
- Open rate **31.59%** · 1,897 opens
- Clicks **848** · click rate 14.12% · CTOR 45%
- Opt-outs 0

## Brand & client engagement

- Blockchain conference — networking drinks with Coinbase, Wealthsimple & others
- Tetra Digital — client drinks
